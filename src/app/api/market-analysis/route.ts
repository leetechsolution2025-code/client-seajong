...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `Bạn là chuyên gia phân tích thị trường cấp cao trong ngành thiết bị vệ sinh, phòng tắm và nhà bếp tại Việt Nam, với hơn 15 năm kinh nghiệm. Thời điểm phân tích: ${now}.
...
===== FRAMEWORK PHÂN TÍCH CHUYÊN GIA =====
...
{
  "executiveSummary": "Tóm tắt điều hành 3-4 câu: đánh giá tổng thể cơ hội và mức độ khả thi của chiến dịch này trong bối cảnh thị trường thiết bị vệ sinh, phòng tắm và nhà bếp Việt Nam 2026",
  "opportunityScore": 82,
