    ...
    >
      <div className="flex-grow-1 d-flex flex-column" style={{ minHeight: 0 }}>
        <WorkflowCard
          ...
          toolbar={
            <div className="px-4 pt-2 d-flex align-items-center justify-content-between" style={{ marginBottom: "-0.5rem" }}>
              <Tab
                tabs={[
              ...
              />
              <div id="plan-timeline-portal" className="d-flex align-items-center gap-3"></div>
            </div>
          }
          contentPadding="p-0"
        >
