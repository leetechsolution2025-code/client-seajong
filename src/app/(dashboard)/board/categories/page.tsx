            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div>
                  ...
                  {editing ? (
                    <Input value={form.code} disabled style={{ opacity: 0.6, fontFamily: "monospace", fontSize: 12 }} />
                  ) : (
                    <div style={{ display: "flex", gap: 6 }}>
                      <Input
                        value={form.code}
                        readOnly
                        style={{ fontFamily: "monospace", fontSize: 12, flex: 1, cursor: "default", opacity: 0.85 }}
                      />
                      <button
                  ...
                  <p style={{ margin: "3px 0 0", fontSize: 10.5, color: "var(--muted-foreground)" }}>
                    Prefix: <b>{activeType.prefix}</b> · Tự sinh tự động
                  </p>
