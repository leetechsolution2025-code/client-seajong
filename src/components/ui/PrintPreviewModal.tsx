...
// ── Google Font ───────────────────────────────────────────────────────────────
const GOOGLE_FONT_URL = "https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700;800;900&family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;1,400&display=swap";
...
export function printDocumentById(
  ...
  const printMargin = orientation === "landscape" ? "15mm" : "20mm 20mm 20mm 25mm";
...
export function PrintPreviewModal({
  ...
  const printMargin = isLandscape ? "15mm" : "20mm 20mm 20mm 25mm";
